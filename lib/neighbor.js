/**
* This module contains logic to identify the nearest neighboring object for the
* object that currently has focus.  Returns a generator function that accepts
* the [Spotlight]{@link module:spotlight/spotlight} instance as an argument.
*
